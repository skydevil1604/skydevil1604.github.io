...
(function($) {
    ...
    $(".white-color").stars({ color:'#ffffff' });
    $(".white-color2").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color3").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color4").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color5").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color6").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color7").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color8").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color9").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
    $(".white-color10").stars({ color:'#ffffff',
        filledIcon: 'fa-star'});
